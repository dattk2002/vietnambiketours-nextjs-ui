...
const Footer = () => {
  ...
  useEffect(() => {
    setIsContactPage(window.location.pathname === "/contact-us");
      ...
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row justify-between border-t border-gray-900 ">
          ...
          <div className="mb-4 md:mb-0 pt-4 pl-2">
            ...
            <p className="text-xs">
              Head Office & Bike shop -{" "}
              <a href="https://example.com" className="text-black">
                map & Connect
              </a>
            </p>
            ...
            <p className="text-xs">
              Email:{" "}
              <a href="mailto:info@vietnambiketours.com" className="text-black">
                info@vietnambiketours.com
              </a>
            </p>
            <p className="text-xs">
              Add: 165 Nguyen Thi Nhung str., Thu Duc Dist., Ho Chi Minh city,
              Vietnam
            </p>
          </div>
          <div className="pt-4">
            ...
            <p className="text-xs">
              Email:{" "}
              <a
                href="mailto:robert.USA@vietnambiketours.com"
                className="text-black text-xs "
              >
                robert.USA@vietnambiketours.com
              </a>
            </p>
            <p className="text-xs">
              Add: 1200 Main, No.1712, Dallas TX 75202, USA
            </p>
          </div>
        </div>
        ...
        <div
          className={`mt-6 ${
            isContactPage ? "" : "border-t border-gray-700 mt-0"
          } pt-4`}
        >
